...
const deleteProductFromCart = (productId) => {
  store.commit("deleteCartProduct", productId);
};
</script>
<template>
  <body>
    <header class="container header flex">
      <RouterLink to="/">
        <h1 class="header__title logo">QPICK</h1>
      </RouterLink>
      <div class="flex">
        <a class="header__link" href="#">
          ...
          <svg
            ...
            xmlns="http://www.w3.org/2000/svg"
          >
            <circle cx="8.7" cy="8.69997" r="8.7" fill="#FFA542" />
          </svg>
          <span class="header__link-num">2</span>
        </a>
        <a class="header__link" href="#" aria-label="Корзина с товарами">
          <svg
            width="24"
            height="25"
            viewBox="0 0 24 25"
          ...
          <span class="header__link-num" aria-label="Количество товаров">{{
    ...
    <main class="container">
      <h2 class="catalog__title" v-if="store.state.cartProductsData.length > 0">
        Корзина
      </h2>
      <h2 class="catalog__title" v-else>Корзина пустая, добавьте товар</h2>
      <div class="catalog flex">
        <ul class="catalog__list flex">
          <li
            class="catalog__item product flex"
            v-for="product in store.state.cartProductsData"
            :key="product.id + product.title"
          >
            <div class="product__desc">
              <a class="product__link" href="#">
                <img class="product__img" :src="product.url" alt="Наушники" />
              </a>
              <div class="product__counter flex">
                ...
                <button
                  ...
                  @click.prevent="product.quantity = product.quantity + 1"
                >
                  <svg
                    width="31"
                    height="30"
            ...
            <div class="product__info flex">
              ...
              <span class="product__price">{{ product.price.new }} ₽</span>
            </div>
            <div class="product__delete flex">
              <svg
              ...
              <p class="">{{ product.price.new * product.quantity }} ₽</p>
            </div>
          </li>
        </ul>
        <div class="total">
          <div class="flex">
            ...
            <p class="total__price">{{ store.getters.totalPrice }} ₽</p>
          </div>
          <a
            class="total__link"
            v-if="store.state.cartProductsData.length > 0"
            href="#"
    ...
    <footer class="container">
      <div class="footer flex">
        <router-link to="/" class="footer__logo logo">QPICK</router-link>
        <ul class="footer__menu menu">
          <li class="menu__item">
            <a class="menu__link" href="#">Избранное</a>
          </li>
          <li class="menu__item">
        ...
        <ul class="footer__menu menu">
          <li class="menu__item">
            <a class="menu__link" href="#">Условия сервиса</a>
          </li>
          <li class="menu__item">
            <div class="footer__lang flex">
              <svg
              ...
              <button class="footer__lang-ru footer__lang-btn">Рус</button>
              <button class="footer__lang-eng footer__lang-btn">Eng</button>
            </div>
          </li>
        </ul>
        <ul class="footer__social social flex">
          ...
          <li class="social__item">
            <a class="social__link" href="#" aria-label="Whatsapp">
              <svg
                width="31"
                height="31"
                viewBox="0 0 31 31"
...
body {
  display: grid;
  grid-template-rows: auto 1fr auto; /* Определяет три строки: автоматическая высота для header, равномерно распределенное пространство для основного контента, и автоматическая высота для footer */
...
header {
  width: 100%;
  grid-row: 1; /* Размещает header в первой строке */
}

main {
  width: 100%;
  grid-row: 2; /* Размещает основной контент во второй строке */
}

footer {
  width: 100%;
  grid-row: 3; /* Размещает footer в третьей строке */
}
